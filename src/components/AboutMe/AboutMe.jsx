    ...
    <section id="about" className="about-me ">
      <div className="about-me-content">
        ...
        <div className="about-me-text">
          ...
          <p>Quand je ne code pas, vous pouvez me trouver en train de jouer et faire du sport. J'apprends constamment et me tiens à jour avec les dernières tendances et technologie en développement web.</p>
        </div>
